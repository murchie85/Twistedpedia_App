...
public class TwistedToday extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jokes.add(new Twisted("21.01.2017","Murchie85","12","To all you beautiful girls out there Happy Valentines day... To all you fat birds chins up, its Pancake day next week...\n"));
        ...
        jokes.add(new Twisted("24.01.2017","Allan","50","Apparently, 1 in 10 people live next door to a pedophile. \n" +
                "Not me though, I live next door to a really sexy 10 year-old girl.\n"));
        jokes.add(new Twisted("29.01.2017","Andy","20","Apparently, 1 in 10 people live next door to a pedophile. \n" +
                "Not me though, I live next door to a really sexy 10 year-old girl.\n"));
